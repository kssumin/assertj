 ...
 */
public class ShouldBeEqual implements ErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory shouldBeEqual(Object actual, Object expected, Representation representation) {
  ...
  /**
   * Creates an error message for the failed assertion.
   *
   * @param description the description of the failed assertion.
   * @param representation the {@link Representation} used to format values.
  ...
  public String create(Description description, Representation representation) {
    return smartErrorMessage(description, representation);
  }

  /**
   * Creates an error message using the default representation.
   *
   * @param description the description of the failed assertion.
   * @return the error message.
   */
  ...
  public String create(Description description) {
    return create(description, representation);
  }

  /**
   * Creates an error message using an empty description and default representation.
   *
   * @return the error message.
   */
  @Override
  public String create() {
    return create(org.assertj.core.description.EmptyTextDescription.emptyDescription(), representation);
  }
}
